public class ExR1_1 {
  ...
  // Declarações e Atribuições de Variáveis: Declare variáveis de vários tipos de
  // dados (int, double, char, boolean) e atribua valores a elas. Imprima seus
  // valores no console para verificar.
